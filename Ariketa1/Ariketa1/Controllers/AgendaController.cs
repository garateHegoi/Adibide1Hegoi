...
namespace Ariketa1.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Kontaktua kontaktua1 = new Kontaktua("13456765", "Hegoi", "Garate");
            kontaktua1.Emaila = "garate.hegoi@uni.eus";
        ...
        {
            Kontaktua kontaktua = new Kontaktua("13456765", "Hegoi", "Garate");
            kontaktua.Emaila = "garate.hegoi@uni.eus";
